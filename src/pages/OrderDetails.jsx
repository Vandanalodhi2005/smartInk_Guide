                            ...
                            <div className="lg:col-span-2 space-y-6 md:space-y-8">
                                ...
                                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-6 md:p-8">
                                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center justify-between border-b border-slate-100 pb-4 md:pb-6 mb-4 md:mb-6">
                                        ...
                                        <div className={`px-4 py-2 rounded-full text-sm font-bold border w-fit ${
                                            order.isDelivered ? 'bg-green-50 text-green-700 border-green-200' :
                                            order.isPaid ? 'bg-blue-50 text-blue-700 border-blue-200' :
                            ...
                            <div className="space-y-4 md:space-y-6">
                                ...
                                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-6">
                                    ...
                                    <div className={`p-3 rounded-xl text-center text-sm font-bold ${
                                        order.isPaid ? 'bg-green-100 text-green-700' : 'bg-red-50 text-red-600'
                                    }`}>
