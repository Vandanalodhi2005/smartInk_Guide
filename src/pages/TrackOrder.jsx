                ...
                <PageContainer>
                    <div className="max-w-2xl mx-auto">
                        ...
                        <motion.div
                            ...
                            className="bg-white p-2 rounded-2xl shadow-lg border border-slate-100 mb-10 transform transition-all hover:shadow-xl"
                        >
                                ...
                                >
                                    ...
                                    <div className="p-6 border-b border-slate-100 bg-slate-50/50 flex flex-wrap justify-between items-center gap-4">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span className={`inline-block px-3 py-1 rounded-full text-sm font-bold ${order.isDelivered ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'
                                                }`}>
                                    ...
                                    <div className="p-8">
                                        <div className="relative">
                                            ...
                                            <motion.div
                                                className="absolute left-[19px] top-4 w-0.5 bg-blue-500 md:left-4 md:top-[19px] md:h-0.5 md:w-0 -z-0"
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-4 relative z-10">
                                                {steps.map((step, index) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all shadow-sm ${isCompleted
                                                                ? 'bg-blue-500 text-white border-4 border-blue-100 scale-110 shadow-lg shadow-blue-100'
