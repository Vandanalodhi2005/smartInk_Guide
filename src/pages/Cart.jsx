                ...
                <div className="max-w-7xl mx-auto px-4 lg:px-8">
                    ...
                    <section className="w-full bg-white rounded-3xl border border-slate-100 p-8 md:p-12 mb-8 shadow-sm">
                        <div className="text-center">
                            ...
                            <p className="mt-4 text-xs font-black text-slate-400 uppercase tracking-[0.3em]">
                                You have <span className="text-slate-900">{cartItems.reduce((acc, item) => acc + Number(item.qty), 0)}</span> items in your inventory
                            </p>
                        </div>
                    </section>
                    ...
                    {cartItems.length === 0 ? (
                        <div className="bg-white border border-dashed border-slate-200 rounded-[3rem] p-20 text-center flex flex-col items-center justify-center space-y-6">
                            ...
                            <Link to="/printers" className="px-8 py-4 bg-slate-900 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-black transition-all">
                                Browse Inventory
                            </Link>
                        </div>
                    ) : (
