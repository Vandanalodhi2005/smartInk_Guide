                    ...
                    <aside className="profile-sidebar">
                        <div className="profile-user-summary">
                            <div className="profile-image-container">
                                <FaUserCircle className="w-full h-full text-blue-100" />
                            </div>
                            ...
                            <div className="profile-section">
                                ...
                                <div className="contact-details">
                                    <div className="contact-detail-item">
                                        <div className="contact-icon" style={{ background: '#eff6ff', color: '#60a5fa' }}>
                            ...
                            <div className="profile-section">
                                ...
                                {loadingOrders ? (
                                    ...
                                    <div className="bg-white rounded-2xl border border-slate-200 p-8 sm:p-12 flex flex-col items-center text-center shadow-sm">
                                        ...
                                        <Link
                                            to="/printers"
                                            className="inline-flex items-center gap-2 px-8 py-3 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-100"
                                        >
                                            Start Shopping
                                        </Link>
                                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-wrap items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
                                                    ...
                                                    <div className="mt-4 sm:mt-0 flex items-center gap-3">
                                                        ...
                                                        <Link
                                                            to={`/order/${order._id}`}
                                                            className="hidden sm:inline-block px-4 py-2 bg-white border border-slate-200 text-slate-600 text-sm font-bold rounded-lg hover:border-blue-500 hover:text-blue-500 transition-colors"
                                                        >
                                                            View Details
                                                        </Link>
                                                    </div>
